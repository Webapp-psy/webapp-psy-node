...
export class Version1677065890207 implements MigrationInterface {
    name = 'Version1677065890207'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "auto_evaluation_test" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "event" character varying NOT NULL, "automaticThoughts" character varying NOT NULL, "isEnabled" boolean NOT NULL DEFAULT true, "deletedAt" TIMESTAMP, "patientId" integer, CONSTRAINT "PK_c1ed78aa511b867ee1dcac6c2f2" PRIMARY KEY ("id"))`);
